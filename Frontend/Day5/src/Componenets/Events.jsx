const Events = () => {
  ...
  <center><h2>Wedding Event</h2></center><br></br>
        ...
        <center><div className="event-description">bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb</div></center>
  <br></br><br></br><br></br>
        <center><h2>Wedding Event</h2></center><br></br>
  ...
  <br></br><br></br><br></br>
        ...
        <center><h2>Wedding Event</h2></center><br></br>
        <center><img src="https://cdn0.weddingwire.com/vendor/136011/3_2/960/jpg/inside-crest-center_51_110631.jpeg" alt="Event" className="event-image" /></center>
        <center><img src="" alt="Event" className="event-image" /></center>
        <center><div className="event-description">bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb</div></center>
  <br></br><br></br><br></br>
